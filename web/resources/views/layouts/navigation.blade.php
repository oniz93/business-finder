<nav x-data="{ mobileMenuOpen: false }" class="bg-gray-800 border-b border-gray-700">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @guest
                    <div class="flex space-x-4">
                        ...
                        <a href="{{ route('register') }}" class="px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-400 bg-gray-800 hover:text-gray-300 focus:outline-none transition ease-in-out duration-150">
                            {{ __('Register') }}
                        </a>
                    </div>
                @endguest
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="mobileMenuOpen = ! mobileMenuOpen" class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-300 hover:bg-gray-900 focus:outline-none focus:bg-gray-900 focus:text-gray-400 transition duration-150 ease-in-out">
    ...
    <div :class="{'block': mobileMenuOpen, 'hidden': ! mobileMenuOpen}" class="hidden sm:hidden bg-gray-800">
        ...
        <div class="pt-4 pb-1 border-t border-gray-700">
            <div class="space-y-1">
                <x-responsive-nav-link :href="route('login')" class="text-gray-300 hover:bg-gray-700 hover:text-white">
                    {{ __('Log in') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('register')" class="text-gray-300 hover:bg-gray-700 hover:text-white">
                    {{ __('Register') }}
                </x-responsive-nav-link>
            </div>
        </div>
