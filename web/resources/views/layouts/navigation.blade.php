    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    @if(in_array(auth()->user()->plan, ['founder', 'innovator', 'enterprise']))
                        ...
                        <div class="hidden sm:block sm:ms-6">
                            <form action="{{ route('business-plan-search.post') }}" method="POST" class="flex">
                                @csrf
                                <input type="text" name="search" placeholder="Search for business plans..." class="px-2 py-1 border border-gray-300 rounded-md dark:bg-gray-900 dark:border-gray-700
       dark:text-gray-100">
       ...
       light mode">
                            ...
                            <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728
       0l-.707.707M6.343 17.657l-.707.707M12 6a6 6 0 100 12 6 6 0 000-12z"/>
                            </svg>
                        </button>
                    @else
                        <input type="hidden" name="theme" value="dark">
                        <button type="submit"
                                class="p-2 rounded-full text-gray-500 hover:text-gray-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
       ...
       mode">
                ...
                @auth
                    ...
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 dark:text-gray-400 bg-white
       ...
       focus:outline-red-500">Log in</a>
                    ...
                    @if (Route::has('register'))
                        <a href="{{ route('register') }}" class="ml-4 font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2
