                    ...
                    <div x-show="open" class="p-8">
                        <dl class="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-8">
                            ...
                            <div class="sm:col-span-1">
                                ...
                                <dd class="mt-1 text-lg font-semibold text-gray-900 dark:text-white">{{ $plan->total_ups }}</dd>
                            </div>
                            <div class="sm:col-span-1">
                                <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Total Downs</dt>
                                <dd class="mt-1 text-lg font-semibold text-gray-900 dark:text-white">{{ $plan->total_downs }}</dd>
                            </div>
